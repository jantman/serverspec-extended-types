...
describe 'Serverspec::Type::Bitlbee' do
  ...
  context '#communicate' do
    it 'logs in' do
      ...
      expect(sock).to receive(:puts).ordered.with("USER foo foo ec2a-live.jasonantman.com :Jason Antman\n")
      ...
      expect(sock).to receive(:readpartial).ordered.with(1024).and_return("PING")
      expect(sock).to receive(:puts).ordered.with(":ec2a-live.jasonantman.com PONG ec2a-live.jasonantman.com :ec2a-live.jasonantman.com\n")
